Contribute to pyramid_localize
==============================

Thank you for taking time to contribute to pyramid_localize!

The following is a set of guidelines for contributing to pyramid_localize. These are just guidelines, not rules, use your best judgment and feel free to propose changes to this document in a pull request.
